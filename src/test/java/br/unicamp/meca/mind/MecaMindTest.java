...
public class MecaMindTest {
    ...
    public void testMecaMindMountActionFromPerceptionWin() throws InterruptedException {
		...
		TestPerceptionSensoryCodelet testPerceptionSensoryCodelet = new TestPerceptionSensoryCodelet("TestPerceptionSensoryCodelet");
		sensoryCodelets.add(testPerceptionSensoryCodelet);
		sensoryCodeletsIds.add(testPerceptionSensoryCodelet.getId());
		
		TestPlanningSensoryCodelet testPlanningSensoryCodelet = new TestPlanningSensoryCodelet("TestPlanningSensoryCodelet");
